	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="Category" data-toggle="dropdown">
						Category</a>
					<!-- <ul class="dropdown-menu" style="background-color: lightgrey">
						<li>
							<h4>
								<a href="" style="padding: 10px; border-width: 30px">DSLR</a>
							</h4>
						<li>
						<li><h4>
								<a href="" style="padding: 10px">SLR</a>
							</h4></li>
						<li><h4>
								<a href="" style="padding: 10px">Digital camera</a>
							</h4></li>
						<li class="divider"></li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if
					test="${empty UserLoginSuccessMessage && empty AdminSuccessMessage}">
